...
As ops
I want to monitor registered http endpoints")]
    public partial class Http_endpoint_monitoring
    {
        [Scenario]
        public void Monitoring_inexistent_http_endpoint()
        {
            Runner.RunScenario(
        ...
        [Scenario]
        public void Monitoring_offline_http_endpoint()
        {
            Runner.RunScenario(
                _ => Given_a_monitor_api_client(),
        ...
        [Scenario]
        public void Monitoring_healthy_http_endpoint()
        {
            Runner.RunScenario(
                _ => Given_a_monitor_api_client(),
        ...
        [Scenario]
        public void Monitoring_faulty_http_endpoint()
        {
            Runner.RunScenario(
                _ => Given_a_monitor_api_client(),
                _ => Given_a_healthy_rest_endpoint(),
                ...
                _ => Then_monitor_should_start_monitoring_the_endpoint(),
                _ => Then_monitor_should_observe_endpoint_status_being_STATUS(EndpointStatus.Healthy),
                _ => When_rest_endpoint_becomes_faulty(),
        ...
        [Scenario]
        public void Monitoring_http_endpoint_returning_3XX_codes()
        {
            Runner.RunScenario(
                _ => Given_a_monitor_api_client(),
                _ => Given_an_endpoint_returning_http_redirects(),
                _ => When_client_registers_the_endpoint(),
                _ => Then_monitor_should_start_monitoring_the_endpoint(),
                _ => Then_monitor_should_observe_endpoint_status_being_STATUS(EndpointStatus.Faulty),
                _ => When_client_requests_endpoint_details(),
