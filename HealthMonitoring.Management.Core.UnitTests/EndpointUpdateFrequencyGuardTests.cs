...
namespace HealthMonitoring.Management.Core.UnitTests
{
    public class EndpointUpdateFrequencyGuardTests
    {
        ...
        {
            return new Endpoint(_timeCoordinator.Object, new EndpointIdentity(Guid.NewGuid(), string.Empty, string.Empty), new EndpointMetadata(string.Empty, string.Empty, null, EndpointMetadata.DefaultMonitorTag, DateTime.UtcNow, DateTime.UtcNow));
        }
