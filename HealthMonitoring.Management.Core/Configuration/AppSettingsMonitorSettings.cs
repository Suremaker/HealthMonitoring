...
namespace HealthMonitoring.Management.Core.Configuration
{
    public class AppSettingsMonitorSettings : IMonitorSettings
    {
        ...
        public TimeSpan HealthUpdateInactivityTimeLimit { get; }
        ...
        public AppSettingsMonitorSettings()
        {
            ...
            HealthUpdateInactivityTimeLimit = GetTimeSpanOrDefault("Monitor.HealthUpdateInactivityTimeLimit", TimeSpan.FromSeconds(20));
